...
$getResult = Login::getEditBlogData($id);

$getEditBlog = mysqli_fetch_assoc($getResult);

$succesData = '';
if (isset($_POST['btn'])){
    $succesData = Login::updateBlogInfo($_POST, $id);
}
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="<?php echo $getEditBlog['blog_title'];?>" name="blog_title" class="form-control" placeholder="Blog Title">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">Short Description</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="short_description"><?php echo $getEditBlog['short_description'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-sm-3 col-form-label">Long Description</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="long_description"><?php echo $getEditBlog['long_description'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
